...
Этот документ описывает конфигурацию и принципы ПРОМПТ-ПРОГРАММИРОВАНИЯ и работы системы `MANDATORY_BEHAVIORAL_FIREWALL.mdc`. Система предназначена для управления рабочим процессом AI-ассистента, обеспечивая высокое качество кода, следование лучшим практикам и принудительное исполнение планов.
